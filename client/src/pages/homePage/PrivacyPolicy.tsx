    ...
    <div className="PrivacyPolicy">
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to WAGER GAMES INC., 110 Channel St, San
          Francisco, CA 94158.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Wager Games, accessible from{" "}
          <a href="http://www.wager.games" rel="noreferrer" target="_blank">
            http://www.wager.games
          </a>
        </li>
        <li>
      ...
      <p>
        ...
        You close Your web browser.You can learn more about cookies here:{" "}
      ...
      <ul>
        <li>By email: hellowagergames@gmail.com</li>
      </ul>
    </div>
  );
};
